...
func (obj LightsparkNodeWithRemoteSigning) GetRipcordUpdates(requester *requester.Requester, first *int, after *string) (*LightsparkNodeToRipcordUpdatesConnection, error) {
    ...
    entity(id: $entity_id) {
        ... on LightsparkNodeWithRemoteSigning {
            ripcord_updates(, first: $first, after: $after) {
                __typename
                lightspark_node_to_ripcord_updates_connection_entities: entities {
